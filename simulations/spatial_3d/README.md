...
- `theta` is the bending magnitude.
...
```text
videos/spatial_3d_case_animation.mp4
```

## Files

```text
figures/spatial_phi_theta_tracking.png
figures/spatial_phi_theta_tracking.pdf
figures/spatial_internal_torques.png
figures/spatial_internal_torques.pdf
figures/spatial_tensions_motors.png
figures/spatial_tensions_motors.pdf
videos/spatial_3d_case_animation.mp4
```

## Notes

This spatial 3D case is the main simulation case reported in the paper. It complements the planar 2D supplementary case by showing how the allocation strategy extends to spatial bending through the geometric projection between local bending torques and curvature-space generalized efforts.
