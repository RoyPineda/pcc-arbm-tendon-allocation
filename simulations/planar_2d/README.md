...
The planar case considers a tendon-driven continuum arm composed of three Piecewise Constant Curvature (PCC) segments. Each segment is actuated by one antagonistic tendon pair and controlled through its scalar curvature coordinate 
```math
q_i
```
